...
export default async function DealsPage({ searchParams }: DealsPageProps) {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
      {/* Page header */}
      <div className="mb-8">
        <p className="section-heading">Sneaker Deals</p>
        <h1 className="text-2xl font-bold tracking-tight mb-6">{heading}</h1>
      ...
      {/* Result count */}
      <p className="text-xs text-brand-gray-400 uppercase tracking-widest mb-6">
